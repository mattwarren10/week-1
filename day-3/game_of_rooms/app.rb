...
west = Room.new("You entered the sky room. You are standing on a cloud. You see a blue sky all around you. They're bouncy like trampolines. [ jump ]", { :jump => "Very bouncy!" })
